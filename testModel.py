...
def predictFolder(model, device, folderPath, saveFigPath=None, gainDiv = 0):
    audio_paths, _ = utils.getAudioPaths(folderPath, percent=1)
    
    audio_test_dataset = AudioDataset(
        audio_paths, outputAudio=True, isTraining=False, num_merge=model.fc2.out_features-1, gain_div=gainDiv)
