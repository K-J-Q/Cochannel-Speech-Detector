...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        # Load model
        model = torch.load('app/model/1_3.pt')
        ...
        self.labelGraph.getAxis('left').setTicks([[(i, str(i)) for i in range(numClass)]])
    ...
    def __selectMicrophone(returnType='device'):
        import subprocess
        micID = []
        micName = []
